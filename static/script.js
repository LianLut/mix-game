...
const recipes = [
    ...
    { name: "Ёрш", image: "fu.png", ingredients: ["алкоголь", "кофе", "вода", "черника", "молоко", "какао-порошок", "корица", "финики", "творог", "мед", "мята", "орео", "тапиока", "черный чай (листовой)", "карамель"] },

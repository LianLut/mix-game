const ingredientsList = [
    "черника", "какао-порошек", "корица", "молоко", "вода",
...
const recipes = [
    ...
    { name: "Тропическое какао", image: "tropic_cacao.png", ingredients: ["какао-порошек", "молоко", "вода", "корица", "финики"] },
    ...
    { name: "Какао с молоком", image: "cacao.png", ingredients: ["молоко", "какао-порошек"] },
    { name: "Какао на воде", image: "cacao_water.png", ingredients: ["вода", "какао-порошек"] },

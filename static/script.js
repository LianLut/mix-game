...
const recipes = [
    ...
    { name: "Китайское пиво", image: "pivo.png", ingredients: ["кофе", "вода", "черника", "молоко", "хлеб", "какао-порошок", "корица", "финики", "творог", "мед", "мята", "орео", "тапиока", "черный чай (листовой)", "карамель"] },
